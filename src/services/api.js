...
const phoneNumbers = {
  ...
  const dayOfWeek = ["DAY_OF_WEEK_UNSPECIFIED", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY","SUNDAY" ]
 ...
 const businessType = ["BUSINESS_TYPE_UNSPECIFIED","CUSTOMER_LOCATION_ONLY","CUSTOMER_AND_BUSINESS_LOCATION"]
...
const placesInfo = {
  ...
  const openForBusiness = ["OPEN_FOR_BUSINESS_UNSPECIFIED", "OPEN","CLOSED_PERMANENTLY","CLOSED_TEMPORARILY"]
  ...
  const relationType = ["RELATION_TYPE_UNSPECIFIED","DEPARTMENT_OF","INDEPENDENT_ESTABLISHMENT_IN"]
