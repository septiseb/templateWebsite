...
export const business = {
  ...
  keywords:
    'Terapia de lenguaje y de habla, oralización para niños pérdidas auditivas, jóvenes y adultos con problemas auditivos',
  ...
  features: [
    {
      ...
      description:
        'Mejora tus habilidades de comprensión y expresión del lenguaje. Desde gramática hasta vocabulario y fluidez, desata todo tu potencial lingüístico.',
      icon: TrophyIcon,
    },
    {
      name: '🎤 Terapia de Habla (Pronunciación)',
      description:
        'Perfecciona la pronunciación para una comunicación clara y efectiva. Transforma tu expresión oral y conquista la confianza en cada palabra.',
      icon: TrophyIcon,
    },
    {
      name: '👂 Oralización de Niños con Pérdidas Auditivas',
      description:
        'Especialistas en implantes cocleares y aparatos auditivos para potenciar habilidades de comunicación oral y auditiva en niños. Abre las puertas a un mundo sonoro pleno.',
      icon: TrophyIcon,
    },
  ],
  images: [
  ...
  faqs: [
    {
      ...
      answer:
        'La Terapia de Lenguaje es un programa especializado que mejora habilidades de comprensión y expresión del lenguaje, abordando gramática, vocabulario y fluidez.',
    },
    {
      question: '¿Cómo beneficia la Terapia de Habla (Pronunciación)?',
      answer:
        'La Terapia de Habla perfecciona la pronunciación para lograr una comunicación más clara y efectiva, potenciando la confianza en la expresión oral.',
    },
    {
      question:
        '¿Cómo ayuda la Rehabilitación a Jóvenes y Adultos con pérdida auditiva?',
      answer:
        'Ofrecemos apoyo comprensivo en la adaptación a la pérdida auditiva, con estrategias efectivas para recuperar la conexión con el mundo sonoro.',
    },
  ],
